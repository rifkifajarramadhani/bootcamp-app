                                ...
                                <div class="mb-5">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <input name="cvc" type="number" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "3">
                                        </div>
                                    </div>
                                </div>
